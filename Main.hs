...
main = runMarcher config world where
  ...
  metalic c = (alpha 0.5 mirror`lighten`(rainbow 0 light $ halfLambert light)`lighten`heidrichSeidel 5.0 5.0 rel light)`darken`(alpha 0.5 $ ambientOcclusion 3.0 0.1`lighten`softShadow 8.0 light)
